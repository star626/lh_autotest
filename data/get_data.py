...
class GetData:
	...
	def write_response_to_cell(self,row,value):
		col = int(data_config.get_response_value())
		self.opera_excel.write_value(row,col,value)
	...
	# 获取响应结果字段
	def get_response_result_field(self, row):
		col = int(data_config.get_response_value())
		data = self.opera_excel.get_cell_value(row, col)
		if data == "":
			return None
	...
	def get_post_result(self, row):
		col = int(data_config.is_depend_post())
		data = self.opera_excel.get_cell_value(row, col)
		if data == "":
			return None
		else:
	...
	def is_excel(self, row):
		col = int(data_config.is_depend_excel())
		data = self.opera_excel.get_cell_value(row, col)
		if data == "":
			return None
		else:
